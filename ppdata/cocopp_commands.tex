...
\providecommand{\algDtables}{\StrLeft{maes red}{\ntables}}
\providecommand{\algCtables}{\StrLeft{maes stp}{\ntables}}
\providecommand{\algBtables}{\StrLeft{maes mid}{\ntables}}
\providecommand{\algAtables}{\StrLeft{maes}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{maes_maes__maes__maes/}
\providecommand{\algorithmA}{maes}
\providecommand{\algorithmB}{maes mid}
\providecommand{\algorithmC}{maes red}
\providecommand{\algorithmD}{maes stp}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.4}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{maes red{}}
\providecommand{\algfolder}{maes_red/}
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.4}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{maes stp{}}
\providecommand{\algfolder}{maes_stp/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
